...
func progressBarView(circle_colors: [CGColor]) -> UIView {
    ...
    let circle_1 = UIBezierPath(arcCenter: center_1, radius: 4, startAngle: -CGFloat.pi / 2, endAngle: 2 * CGFloat.pi, clockwise: true)
    let circle_2 = UIBezierPath(arcCenter: center_2, radius: 4, startAngle: -CGFloat.pi / 2, endAngle: 2 * CGFloat.pi, clockwise: true)
    let circle_3 = UIBezierPath(arcCenter: center_3, radius: 4, startAngle: -CGFloat.pi / 2, endAngle: 2 * CGFloat.pi, clockwise: true)
